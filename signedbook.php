...
if (isset($_POST['book_user'])) {
  ...
  if (count($errors) == 0) {
  	...
  	$sql = "INSERT INTO researvation1(leavingfrom,leavingto,departure,company_name,coach_type,seat,payment) 
  			  VALUES('$leavingfrom','$leavingto','$departure','$company_name','$coach_type','$seat','$payment')";
  	mysqli_query($db, $sql);
  	$_SESSION['name'] = $name;
...
<body>
  ...
  <form method="post" action="signedbook.php">
