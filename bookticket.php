...
if (isset($_POST['book_user'])) {
  ...
  if (count($errors) == 0) {
  	...
  	mysqli_query($db, $sql);
	$sqll = "SELECT id from researvation ORDER BY id desc LIMIT 1";
...
<body>
  <div class ="header">
  <p>Already a member? <a href="signedbook.php">Member Researvation</a></p>
  </div>
  <p>Not a member? </p>
	<div>
	<div class="header">
  ...
  <form method="post" action="bookticket.php">
	...
	<div class="input-group">
  	...
  	<div class="input-group">
  	  <label>Payment method (Bkash/Rocket/Credit card/cash)</label>
